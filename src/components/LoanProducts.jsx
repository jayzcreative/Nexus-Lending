...
const products = [
    { 
        ...
        features: [
            ...
            "Funds as fast as one business day",
            "Competitive APR models"
        ]
    },
    { 
        name: "Mortgage", 
        icon: "🏠", 
        range: "Rates as low as 6.25%",
        features: [
            "Low down payment options",
            "Get pre-approved in minutes",
            "Zero hidden lender fees",
            "Expert support team",
    ...
    { 
       name: "Student Loans", 
        icon: "🎓", 
        range: "Flexible Repayment",
        features: [
            "Undergrad & Graduate funding",
            "Parent Plus & MBA specialized loans",
            "Refinance to lower your monthly rate",
